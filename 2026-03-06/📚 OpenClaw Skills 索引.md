# 📚 OpenClaw Skills 索引 - 2026-03-06

## 📈 今日统计
- **技能总数**: 10 个
- **信息来源**: OpenClaw Skills, OpenClaw Docs, ClawHub
- **收集时间**: 19:30
- **维护状态**: ✅ 正常
...
### 1. OpenClaw Browser Control - 浏览器控制技能

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 工具类
...
---
### 2. OpenClaw Feishu Integration - 飞书集成

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 通讯类
...
---
### 3. OpenClaw Cron - 定时任务管理

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 自动化
...
---
### 4. OpenClaw Subagents - 子代理编排

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 高级功能
...
---
### 5. OpenClaw Memory - 记忆管理

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 核心功能
...
---
### 6. OpenClaw Healthcheck - 健康检查技能

**来源**: OpenClaw Skills | **类型**: 官方技能 | **分类**: 运维类
...
---
### 7. OpenClaw Weather - 天气查询技能

**来源**: OpenClaw Skills | **类型**: 官方技能 | **分类**: 工具类
...
---
### 9. OpenClaw Canvas - 画布展示技能

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 展示类
...
---
### 10. OpenClaw TTS - 语音合成技能

**来源**: OpenClaw Docs | **类型**: 官方技能 | **分类**: 多媒体
...
基于今日收集的技能，OpenClaw 生态系统的主要特点包括：

### 核心能力
1. **自动化工具** - 浏览器控制、定时任务、文件操作
2. **通讯集成** - 飞书、Discord、Telegram 等多平台支持
3. **记忆系统** - 长期记忆和短期记忆的完整管理
4. **子代理编排** - 并行任务处理和复杂工作流

### 扩展生态
1. **ClawHub 社区** - 丰富的第三方技能市场
2. **官方文档** - 完善的使用指南和 API 文档
3. **活跃社区** - Discord 等渠道的技术交流

### 学习路径建议
1. **入门** - 从基础工具类技能开始（weather, healthcheck）
2. **进阶** - 学习核心功能（memory, cron, subagents）
3. **高级** - 掌握集成和编排（feishu, browser, canvas）
