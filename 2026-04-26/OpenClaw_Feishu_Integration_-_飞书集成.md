# OpenClaw Feishu Integration - 飞书集成
...
## 🔧 使用方法
```
feishu_doc action=read/write | feishu_wiki action=spaces/nodes | feishu_bitable
```
...
## 🔗 相关链接
- [🔍 Google 搜索此技能](https://www.google.com/search?q=OpenClaw+OpenClaw_Feishu_Integration_-_飞书集成)
